...
class MainMenu(QWidget):
    ...
    def initUI(self):
        ...
        self.h_line.addWidget(self.but_1, alignment=Qt.AlignLeft)
        self.h_line.addWidget(self.but_2, alignment=Qt.AlignLeft)
        self.h_line.addWidget(self.but_3, alignment=Qt.AlignLeft)
        self.h_line.addWidget(self.but_4, alignment=Qt.AlignLeft)
        self.h_line.addWidget(self.but_5, alignment=Qt.AlignLeft)
